...
public class DBManager {
    ...
    public final static String CREATE_TAB_GONGZAI = "CREATE TABLE GONGZAI("
            + "ID INTEGER PRIMARY KEY AUTOINCREMENT,"
            + "f_group_id text,"
            + "f_isChat integer,"
            + "f_type integer,"
    ...
    public final static String CREATE_TAB_PROVINCECITYDISTRICT = "CREATE TABLE PROVINCECITYDISTRICT("
            + "ID INTEGER PRIMARY KEY AUTOINCREMENT,"
            + "provinceId text,"
            + "provinceName text,"
            + "cityId text,"
