...
@SuppressWarnings("unused") public class BaseAdapterHelper {
    ...
    protected BaseAdapterHelper(Context context, ViewGroup parent, int layoutId, int position) {
        ...
        if (null != com.juziwl.commonlibrary.view.easycommonadapter.Adapter.singleton &&
    ...
    public BaseAdapterHelper setImageHead(@IdRes int viewId, String url) {
        ...
        LoadingImgUtil.loadimg(url, view, null, true);
        return this;
    }
    // 设置imagehead 头像带有大小的
 ...
 //其他控件组合在一起此处提供所有的控件设置方法
    ...
    // 多图设置
// private void setMulityPics(, final String imgs) {
//
//
//
//     String pic[] = imgs.split(";"); // 获取第一张图片  班级动态内容
//     LoadingImgUtil.loadimg(Global.baseURL + pic[0], viewHolder.class_dynamic_image, null, false);
//     viewHolder.class_dynamic_image.getLayoutParams().width = ViewGroup.LayoutParams.MATCH_PARENT;
//     viewHolder.class_dynamic_image.getLayoutParams().height = CommonTools.dip2px(mContext, 150);
//     viewHolder.class_dynamic_image.setOnClickListener(new View.OnClickListener() {
//         @Override
//         public void onClick(View v) {
//             // 跳转播放页面
//             Bundle bundle = new Bundle();
//             bundle.putInt("ID", 0);
//             bundle.putString("pics", classid);
