...
public class ImageWatcher extends FrameLayout implements GestureDetector.OnGestureListener, ViewPager.OnPageChangeListener {
    ...
    private int mErrorImageRes = R.mipmap.common_falseimg;
            ...
            if (mTouchMode == TOUCH_MODE_DOWN) {
                if (Math.abs(moveX) > mTouchSlop || Math.abs(moveY) > mTouchSlop) {
                    ...
                    if (vsDefault == null) {
                        ...
                        String imageOrientation = (String) iSource.getTag(R.id.common_image_orientation);
    ...
    public void onLongPress(MotionEvent e) {
        ...
        //    PicSaveDialog.getInstance().createSavePicDialog(this.getContext(),this,mUrlList.get(vPager.getCurrentItem()),null);
            ...
            Glide.with(imageView.getContext()).load(mUrlList.get(pos)).asBitmap().into(new SimpleTarget<Bitmap>() {
                ...
                public void onResourceReady(Bitmap resource, GlideAnimation<? super Bitmap> glideAnimation) {
                    ...
                    if (resourceImageWidth * 1f / resourceImageHeight > mWidth * 1f / mHeight) {
                        ...
                        imageView.setTag(R.id.common_image_orientation, "horizontal");
                    } else {
                        ...
                        imageView.setTag(R.id.common_image_orientation, "vertical");
                    }
