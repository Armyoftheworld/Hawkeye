package com.juziwl.commonlibrary.view.recycler;
...
public class HeaderViewRecyclerAdpater extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        System.out.println(String.format(Locale.CHINA, "onCreateViewHolder viewType = %d", viewType));
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        System.out.println(String.format(Locale.CHINA, "position = %d\tviewType = %d", position, viewType));
