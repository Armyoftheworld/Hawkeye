...
public class SearchSwipeListView extends ListView {
	...
	public SearchSwipeListView(Context context) {
		this(context, null);
	}

	public SearchSwipeListView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public SearchSwipeListView(Context context, AttributeSet attrs, int defStyle) {
