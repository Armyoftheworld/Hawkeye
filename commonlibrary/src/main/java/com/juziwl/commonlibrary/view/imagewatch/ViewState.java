...
public class ViewState {
    static final int STATE_ORIGIN = R.id.common_state_origin; // 缩略图初始
    static final int STATE_THUMB = R.id.common_state_thumb; // 缩略图居中
    static final int STATE_DEFAULT = R.id.common_state_default; // 高清图初始
    static final int STATE_CURRENT = R.id.common_state_current; // 当前状态
    static final int STATE_TEMP = R.id.common_state_temp; // 临时目标
    static final int STATE_DRAG = R.id.common_state_touch_drag; // 高清图拖拽起点
    static final int STATE_TOUCH_DOWN = R.id.common_state_touch_down; // 高清图按下起点
    static final int STATE_TOUCH_SCALE_ROTATE = R.id.common_state_touch_scale_rotate; // 高清图缩放旋转起点
