...
public class SmileyParser {
    ...
    private ArrayMap<String, SoftReference<CharSequence>> stringsMap = new ArrayMap<>(100);
    ...
    public static final int DEFAULT_SMILEY_TEXTS = R.array.common_default_smiley_texts;
...
//    }
    ...
    public CharSequence replace(CharSequence text, TextView textView) {
        ...
        sb.append(text.toString()).append(";").append(textView.getTextSize());
        String key = sb.toString();
        SoftReference<CharSequence> reference = stringsMap.get(key);
        if(reference != null){
            CharSequence charSequence = reference.get();
        ...
        CharSequence spanned = Html.fromHtml(builder.replaceAll("[\\n]", "<br/>"), getImageGetterInstance(textView), null);
        SoftReference<CharSequence> softReference = new SoftReference<>(spanned);
        stringsMap.put(key, softReference);
        return spanned;
    }
