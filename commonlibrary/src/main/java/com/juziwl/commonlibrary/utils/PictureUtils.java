...
// 堆栈模糊算法由Mario Klingemann <mario@quasimondo.com>所创作
        ...
        Bitmap overlay = Bitmap.createBitmap(
                (int) (sentBitmap.getWidth() / scaleFactor),
                (int) (sentBitmap.getHeight() / scaleFactor),
                Bitmap.Config.ARGB_8888);/*Bitmap bitmap = BitmapFactory.decodeResource(getResources(),R.drawable.icon2);//返回的估计是一个immutalbe的bitmap；所以不能用setpixels
