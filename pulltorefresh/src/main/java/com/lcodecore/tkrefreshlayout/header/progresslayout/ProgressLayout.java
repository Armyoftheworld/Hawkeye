...
public class ProgressLayout extends FrameLayout implements IHeaderView {
    ...
    private void createProgressView() {
        ...
        LayoutParams params = new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT, Gravity.TOP | Gravity.CENTER_HORIZONTAL);
        params.topMargin = DensityUtil.dp2px(getContext(), 20);
    ...
    public void onPullingDown(float fraction, float maxHeadHeight, float headHeight) {
        System.out.println(String.format(Locale.CHINA, "onPullingDown\tfraction = %f\tmaxHeadHeight = %f\theadHeight = %f", fraction, maxHeadHeight, headHeight));
        if (!mIsBeingDragged) {
    ...
    public void onPullReleasing(float fraction, float maxHeadHeight, float headHeight) {
        System.out.println(String.format(Locale.CHINA, "onPullReleasing\tfraction = %f\tmaxHeadHeight = %f\theadHeight = %f", fraction, maxHeadHeight, headHeight));
    ...
    public void startAnim(float maxHeadHeight, float headHeight) {
        System.out.println(String.format(Locale.CHINA, "startAnim\tmaxHeadHeight = %f\theadHeight = %f", maxHeadHeight, headHeight));
        mCircleView.setVisibility(View.VISIBLE);
        mCircleView.getBackground().setAlpha(MAX_ALPHA);
        mProgress.setAlpha(MAX_ALPHA);
        ViewCompat.setScaleX(mCircleView, 1f);
