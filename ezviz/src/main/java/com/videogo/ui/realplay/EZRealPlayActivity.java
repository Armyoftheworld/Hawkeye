   ...
   private void  exit(){
    ...
    private void setVideoLevel() {
        ...
        if (mCurrentQulityMode.getVideoLevel() == EZVideoLevel.VIDEO_LEVEL_FLUNET.getVideoLevel()) {
            ...
            mRealPlayQualityBtn.setText(R.string.quality_sc);
        }
    }
...
//        mTalkPopupWindow.showAtLocation(parent, Gravity.BOTTOM, 0, 0);
    ...
    private void openQualityPopupWindow(View anchor) {
        ...
        Button qualityScBtn = (Button) layoutView.findViewById(R.id.quality_sc_btn);
        qualityScBtn.setOnClickListener(mOnPopWndClickListener);
        ...
        } else if (mCameraInfo.getVideoLevel() == EZVideoLevel.VIDEO_LEVEL_SUPERCLEAR){
            qualityScBtn.setEnabled(false);
        }
